# -*- coding: utf-8 -*-
"""Stock_Automation.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1sk9fn_Gb2ohQxIy3Uu0BsOrqnqEhWA0L
"""
...
This file updates the original simple script by:
  - fetching current, prev close, day high/low, 52w high/low, volume, avg volume,
    market cap, P/E, dividend yield, SMA50/SMA200 (computed if needed)
  - producing a compact but information-rich message with summary and per-stock blocks
  - keeping send_telegram compatible with the original sendMessage API

Usage: same as original script — set TELEGRAM_BOT_TOKEN and TELEGRAM_CHAT_ID env vars
and run the script. Or import the functions for local preview.
"""
import os
import sys
import logging
...
"""You can set environment variables using the `%env` magic command. Replace the placeholder values with your actual Telegram bot token and chat ID."""

# Commented out IPython magic to ensure Python compatibility.
# %env TELEGRAM_BOT_TOKEN=8088642781:AAF05ZLsDqmAiZCAAALRv9neUvS9ZSrhPE8
# %env TELEGRAM_CHAT_ID=-1002955635723
